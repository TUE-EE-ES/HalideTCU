...
struct StageScheduleContents {
    ...
    StageScheduleContents()
        : fuse_level(FuseLoopLevel()), touched(false),
          allow_race_conditions(false), tensor_core(false), atomic(false),
...
StageSchedule StageSchedule::get_copy() const {
    ...
    copy.contents->tensor_core = contents -> tensor_core;
...
TensorOpDirective &StageSchedule::tensorOp() {
    return contents->tensorOp;
}

const TensorOpDirective &StageSchedule::tensorOp() const {
    return contents->tensorOp;
}
...
bool &StageSchedule::tensor_core() {
    return contents->tensor_core;
}

bool StageSchedule::tensor_core() const {
    return contents->tensor_core;
}
