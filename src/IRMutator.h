...
protected:
  // ExprNode<> and StmtNode<> are allowed to call visit (to implement
  // mutate_expr/mutate_stmt())
  ...
  virtual Stmt visit(const TensorOp *);
...
std::pair<Region, bool> mutate_region(Mutator *mutator, const Region &bounds,
                                      Args &&... args) {
