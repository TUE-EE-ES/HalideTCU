...
Stmt build_loop_nest(
    ...
    for (const Split &split : splits) {
        ...
        if(split.inner == "")  splits_result = apply_outer_split(split, is_update, prefix, dim_extent_alignment);
        else  splits_result = apply_split(split, is_update, prefix, dim_extent_alignment);
